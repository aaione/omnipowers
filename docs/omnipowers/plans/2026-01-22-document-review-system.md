...
> **For agentic workers:** REQUIRED: Use omnipowers:subagent-driven-development (if subagents available) or omnipowers:executing-plans to implement this plan.
...
**Spec:** docs/omnipowers/specs/2026-01-22-document-review-system-design.md
...
**Dispatch after:** Spec document is written to docs/omnipowers/specs/
...
```markdown
> **For agentic workers:** REQUIRED: Use omnipowers:subagent-driven-development (if subagents available) or omnipowers:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
