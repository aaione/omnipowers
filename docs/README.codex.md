...
Complete guide for using Omnipowers with OpenAI Codex.
...
The bootstrap file is included in the repository at `.codex/omnipowers-bootstrap.md`. Codex will automatically use it from the cloned location.
...
```
Run ~/.codex/omnipowers/.codex/omnipowers-codex find-skills to show available skills
```
...
```
Run ~/.codex/omnipowers/.codex/omnipowers-codex find-skills
```

### Loading a Skill

```
Run ~/.codex/omnipowers/.codex/omnipowers-codex use-skill omnipowers:brainstorming
```

### Bootstrap All Skills

```
Run ~/.codex/omnipowers/.codex/omnipowers-codex bootstrap
```
...
**Location:** `~/.codex/omnipowers/lib/skills-core.js`
...
- `Skill` tool → `~/.codex/omnipowers/.codex/omnipowers-codex use-skill`
...
1. Verify installation: `ls ~/.codex/omnipowers/skills`
2. Check CLI works: `~/.codex/omnipowers/.codex/omnipowers-codex find-skills`
3. Verify skills have SKILL.md files

### CLI script not executable

```bash
chmod +x ~/.codex/omnipowers/.codex/omnipowers-codex
```
