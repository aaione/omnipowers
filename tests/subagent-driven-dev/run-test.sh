...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/omnipowers
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/omnipowers-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using omnipowers:subagent-driven-development. The plan is at: $PLAN_PATH"
