...
mkdir -p "$HOME/.config/opencode/omnipowers"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/omnipowers/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/omnipowers/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/omnipowers/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/omnipowers.js" "$HOME/.config/opencode/omnipowers/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/omnipowers/.opencode/plugins/omnipowers.js" \
       "$HOME/.config/opencode/plugins/omnipowers.js"
...
echo "Plugin installed to: $HOME/.config/opencode/omnipowers/.opencode/plugins/omnipowers.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/omnipowers.js"
